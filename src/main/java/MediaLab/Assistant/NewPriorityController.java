...
public class NewPriorityController {
...
//            	textArea.minHeightProperty().bind(lowerOptions.heightProperty().multiply(0.8));
//            	textArea.maxHeightProperty().bind(lowerOptions.heightProperty().multiply(0.8));
            	textArea.fontProperty().bind(titleField.fontProperty());
            	
            	save.minWidthProperty().bind(lowerOptions.widthProperty());
            	save.maxWidthProperty().bind(lowerOptions.widthProperty());
	...
	public void save() throws IOException {
		if (titleField.getText().trim().isEmpty()) {
			displayNewObjectPopUp("You cannot create a new priority without a title.");
		} else if (PriorityList.instance.get(titleField.getText().trim()) != null) {
			displayNewObjectPopUp("A priority with this title already exists.");
		} else {
			...
			Priority.newPriority(title, description);
			dashboardPressed();
		}
	}
