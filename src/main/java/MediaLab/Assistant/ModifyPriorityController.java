...
public class ModifyPriorityController {
	...
	public void save() throws IOException {
		...
		} else if (PriorityList.instance.get(titleField.getText().trim()) != null && !PriorityList.instance.get(titleField.getText().trim()).equals(this.priority)) {
	...
	private void initializeFields() {
		titleField.setText(this.priority.getTitle());
		if (this.priority.getDescription() != null) {
			textArea.setText(this.priority.getDescription());
		} else {
			textArea.setText("");
		}
	}
